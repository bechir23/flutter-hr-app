...
static const String screenroute='experiencedetails';
 ...
 final  Map <String, dynamic>  m ;
  ...
  Widget build(BuildContext context) {
                            ...
                            children: [
                              Expanded(
                                child: GestureDetector(
                                  onTap: () {
                                   FirebaseFirestore.instance.collection('experienceletter').doc(d).delete();
   ...
   IconButton(onPressed: (){Navigator.pushNamed(context,'experience');}, icon: const Icon(Icons.exit_to_app_rounded)),
