...
class _addmedicalState extends State<addmedical> {
 ...
 final _schemecontroller=TextEditingController();
  ...
  Future Submit(String a,String b,int c,String d,int e)
async{
...
'number':e,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(centerTitle:true,title: const Text('Medical',style: TextStyle(color: Colors.white,fontSize: 40),),backgroundColor: const Color.fromARGB(255, 223, 130, 161),leading: IconButton(
...
content: Text('Phone number and cost are required',style: TextStyle(color: Colors.red),),
      );    
         }
      ...
      child:   Column(crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [Expanded(
          ...
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _schemecontroller,),
          ...
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _categorycontroller,),
          
          const SizedBox(height: 20,),
          const Text('Cost'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _costcontroller,inputFormatters: [FilteringTextInputFormatter.digitsOnly]),
          
          const SizedBox(height: 20,),
          const Text('Member'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _membercontroller,),
          
          const SizedBox(height: 20,),
          const Text('Membership number'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _numbercontroller,inputFormatters: [FilteringTextInputFormatter.digitsOnly],),
