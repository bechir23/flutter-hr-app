      ...
      body: Padding(
        ...
        child: Column(
            ...
            children: [
              ...
              Text(
                widget.m['client'] ?? 'No email available',
                style: const TextStyle(fontSize: 20, color: Colors.blue),
              ),
              const Text(
                'Project Cost',
              ...
              Text(
                widget.m['head'] ?? 'No email available',
                style: const TextStyle(fontSize: 20, color: Colors.blue),
              ),
              const Text(
                'Project Manager',
              ...
              Text(
                widget.m['manager'] ?? 'No email available',
                style: const TextStyle(fontSize: 20, color: Colors.blue),
              ),
              const Text(
                'Project User',
              ...
              Text(
                widget.m['user'] ?? 'No email available',
                style: const TextStyle(fontSize: 20, color: Colors.blue),
              ),
            ]),
      ),
