...
class clientview extends StatefulWidget {
  static const screenroute='clientview';
...
class _clientviewState extends State<clientview> {
  ...
  return Scaffold(
   ...
   // Provider.of<traveldata>(context,listen: false).update() ;
      ...
      },),title: const Text('Client',textAlign:TextAlign.center,style: TextStyle(color: Colors.white,fontSize: 40),),),
    ...
    return ListTile(
      ...
      trailing: Checkbox(
        ...
        if (value!) {
            ...
            projectData.updateSelected(3, name);
