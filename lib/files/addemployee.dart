  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child:   Form(key: formkey,
        ...
        TextFormField(textAlign: TextAlign.center,autofocus: true,controller: _descriptioncontroller,validator: (value) {
            if (value == null || value.isEmpty) {
        ...
        isLoading = true;
            ...
            sendEmail(name: _descriptioncontroller.text,email: user.email??'', subject: FileName!, message:Provider.of<fileview>(context,listen: false).selected );
          Submit(
        _namecontroller.text,
        _descriptioncontroller.text,
        
        fileToDisplay!.path,
        _foldercontroller.text,Provider.of<fileview>(context,listen: false).selected
          ).then((value) {
        setState(() {
          isLoading = false;
        });
