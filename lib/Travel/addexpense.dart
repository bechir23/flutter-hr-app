...
'time':date,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(centerTitle:true,title: const Text('Expense',style: TextStyle(color: Colors.white,fontSize: 40),),backgroundColor: const Color.fromARGB(255, 223, 130, 161),leading: IconButton(
      ...
      child:   Column(crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [Expanded(
          ...
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _Ticketcontroller,),
          
          const SizedBox(height: 10,),
          const Text('LODGING'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _Lodgingcontroller,),
          
          const SizedBox(height: 10,),
          const Text('BOARDING'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _Boardingcontroller,),
          ...
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _Localconveyancecontroller,),
          
          const SizedBox(height: 10,),
          
          const Text('INCIDENTALS'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _Incidentalscontroller,),
          
          const SizedBox(height: 10,),
          const Text('OTHERS'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _Otherscontroller,),
