...
Future Submit(String a,DateTime b,String c,String d,String e,String f,String g,String h,String i,String j,String k)
async{
...
'manager':k
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:  AppBar(centerTitle:true,title: const Text('Exit',style: TextStyle(color: Colors.white,fontSize: 40),),backgroundColor: const Color.fromARGB(255, 223, 130, 161),
   ...
   const Text('Separation',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.red, ),),
          ...
          , icon:const Icon(Icons.calendar_today),label: const Text('Separation',style: TextStyle(fontSize: 20),),),
          ...
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _reasoncontroller,),
          
          const SizedBox(height: 10,),
                          const Text('Checklist for exit inter...',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.red),),
      
          
          
          const Text('Company Vehicule handed in'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _vehiculecontroller,),
          
          const SizedBox(height: 10,),
        
          const Text('All library books submitted'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _bookscontroller,),
          
          const Text('Interview'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _interviewcontroller,),
          ...
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _lettercontroller,),
          
          const SizedBox(height: 10,),
          
          const Text('All equipments handed in'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _equipmentscontroller,),
          ...
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _securitycontroller,),
          
          const SizedBox(height: 10,),     
          
          const Text('Notice period followed'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _noticecontroller,),
          
          const SizedBox(height: 10,),
          
          const Text('Manager/Supervisor clearance'),
          
          TextField(textAlign: TextAlign.center,autofocus: true,controller: _managercontroller,),
         ...
         isLoading ? const Center(child: CircularProgressIndicator())  :
           Expanded(
             child: GestureDetector(
              ...
              Submit(user.email ?? 'not enregistred',e,_reasoncontroller.text,_vehiculecontroller.text,_bookscontroller.text,_interviewcontroller.text,_lettercontroller.text,_equipmentscontroller.text,_securitycontroller.text,_noticecontroller.text,_managercontroller.text ).then((value){Navigator.pop(context);});
            },
              child: Padding(
                padding: const EdgeInsets.all(12.0),
                child: Container(padding: const EdgeInsets.all(20),
