...
class _exitState extends State<exit> {
  ...
  Widget build(BuildContext context) {
   return Scaffold(
      ...
      stream: FirebaseFirestore.instance.collection('exit').snapshots(),
      ...
      return const SizedBox(); // You can return an empty widget or handle this case as per your requirement.
            ...
            return TextButton(
              ...
              context,
              MaterialPageRoute(
                builder: (context) => exitdetails(m: data, d: document.id),
              ),
    ...
    // if(snapshot.hasData && snapshot.data!.docs.isNotEmpty) {               return Center(child: const Text('No tasks found'));
      ...
      leading: IconButton(onPressed: (){Navigator.pushNamed(context,'organization');}, icon: Icon(Icons.exit_to_app)),
      actions:[ IconButton(icon: const Icon(Icons.add),onPressed: ()  {
     
          setState(() {
         
          Navigator.pushNamed(context,'addexit');
