...
class _leaverequestState extends State<leaverequest> {
  ...
  Future Submit(String a, DateTime c, DateTime d, String e, String b) async {
                          ...
                          : Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  Submit(user.email ?? 'not enregistred', e, f,
                                          _reasoncontroller.text, selecteditem!)
                                      .then((value) {
                                    Navigator.pop(context);
                                  });
                                },
